...
class reading_MEP(gr.top_block, Qt.QWidget):
    def __init__(self, data_dir, channel="chA", start_sec=7*60):
...
def main(top_block_cls=reading_MEP, options=None):
    ...
    parser.add_argument("--channel", default="chA", help="DigitalRF channel name (default: chA)")
    parser.add_argument("--start-sec", type=float, default=7*60, help="Initial seek time in seconds (relative)")
    parser.add_argument("--home-dir", type=str, default="/media/research1/T9", help="Home directory for data files")
